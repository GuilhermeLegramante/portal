            ...
            <div class="card-body login-card-body" style="opacity: 200%;">
                ...
                <form action="{{ route('enviarPin') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="cpf" onblur="javascript: formatarCampo(this);" maxlength="14"
                            class="form-control" value="{{ old('cpf') }}" placeholder="Seu CPF" autofocus required>
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" class="form-control" placeholder="Seu e-mail cadastrado"
                            required>
                        <div class="input-group-append">
                            <div class="input-group-text">
