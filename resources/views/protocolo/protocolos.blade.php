...
@section('title', 'hsPortal - Emissão Protocolo')
...
<div class="card card-info">
    ...
    <div style="padding: 1%;" class="accordion" id="accordionExample">
        <div class="card">
            <div class="card-header" id="headingOne">
                <h5 class="mb-0">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne"
                        aria-expanded="false" aria-controls="collapseOne">
                        {{$protocolos[0]->numero}} - {{$protocolos[0]->dataemissao}}
                    </button>
                </h5>
            </div>
...
<form id="" action="" class="form" method="post" enctype="multipart/form-data">
    <div class="card-body">
        @csrf
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="informacoesadicionais" placeholder="Opcional" id=""
                            class="form-control">
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea name="descricao" class="form-control" rows="4"
                            placeholder="Informe detalhadamente o assunto do protocolo ..."></textarea>
                    </div>
                </div>
            </div>
            <!-- fim terceira linha -->
