            ...
            <tbody>
                <tr>
                    <td style="height: 100px; vertical-align: middle; width: 10%;">
                        <img src="{{ public_path('img/brasao.png') }}" style="width: 100px; height: 100px;">
                    </td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="font-size: 12px;">
                                        <span style="font-weight: bold;">Emissor:</span> {{ session('nome') }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="font-size: 12px; height: 15px; text-align: right; vertical-align: top;">
                                        <span style="font-weight: bold;">Email:</span> {{ session('clientEmail') }}
                                    </td>
                                </tr>
                                <tr>
                                    <td
